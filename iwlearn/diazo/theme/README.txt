...
To use this skin, on a buildout based installation:
    ...
    1. Unpack iwlearn.diazo.theme package to src/ folder of your 
    buildout
    ...
    Zope to configure iwlearn.diazo.theme.

    If another package depends on the iwlearn.diazo.theme egg or 
